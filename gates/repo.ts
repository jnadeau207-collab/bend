...
allow("bend2/base.bend", 33500);
allow("bend2/bend.lean", 400000);
allow("bend2/bend.ts", 44500);
allow("bend2/comp.ts", 66000);
...
allow("bend2/docs/F64_CONTRACT.md", 2500);
allow("bend2/docs/F64_IMPLEMENTATION.md", 1500);
...
allow(/^conformance\/[A-Za-z0-9_]+\.(bend|md|py|sh)$/, 4000);
allow(/^conformance\/receipts\/[0-9-]+\.txt$/, 2000);
